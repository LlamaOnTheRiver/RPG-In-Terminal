...
def heal_small():
    ...
    print(f"You eat the bread. It's dry, but you feel better (+{amount} HP).")

def heal_large():
    amount = 50
    data.PLAYER["hp"] = min(data.PLAYER["max_hp"], data.PLAYER["hp"] + amount)
    print(f"You drink the potion. A warm glow spreads through your limbs (+{amount} HP).")
...
def teleport_home():
    ...
    print("The scroll vanishes in a flash of blue light! You are home.")
