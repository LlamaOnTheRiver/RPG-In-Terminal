...
DUNGEON = {
    ...
    2: {
        ...
        "stairs":{
                (4,4): {"target_map": 1, "target_x": 8, "target_y": 2},
                (7,17): {"target_map": 3, "target_x": 20, "target_y": 3},
        },
        "monsters": [
            ...
            {"name": "Goblin", "x": 13, "y": 4, "marker": "\033[91mM\033[0m"},
            {"name": "Goblin", "x": 13, "y": 8, "marker": "\033[91mM\033[0m"},
            {"name": "Goblin", "x": 5, "y": 8, "marker": "\033[91mM\033[0m"},
        ],
        "shop":{
    ...
    3: {
        ...
        "stairs": {
            (3, 20): {"target_map": 2, "target_x": 17, "target_y": 7},
        },
        "monsters": [
            {"name": "Rat", "x": 2, "y": 0, "marker": "\033[91mM\033[0m"},
            {"name": "Rat", "x": 5, "y": 0, "marker": "\033[91mM\033[0m"}
...
TILE_EFFECTS = {
        ...
        "w": {"msg": "This wall seems a little loose. Your not sure how to get past it.", "block": True},
    }
...
DIALOGUE_NODES = {
    ...
    (2, 15, 10): {
                "speaker": "Chest",
                "text": ["An overflowing chest full of treasure right at your fingertips. Greed"
                         "takes over, You start to fill your pockets, but then a note catches",
                         "your eye. It says, 'Gold isn't everything, walk away now and be",
                         "satisfied or forever be weighted down by the precious metal of greed.'"],
                "options": {
                    "1": {
                        "text": "The note is completely right. Walk away from the treasure.",
                        "effect": {"sanity": random.randint(5, 20)},
                        "next_node": "end",
                    },
                    "2": {
                        "text": "Take the note and throw it on the ground. The gold is yours",
                        "effect": {"gp": random.randint(25, 75)},
                        "next_node": "end",
